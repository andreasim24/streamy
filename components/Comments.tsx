        ...
        <div className="absolute bottom-0 left-0 right-0  pb-6 px-2 md:px-10 ">
          <form onSubmit={addComment} className="flex gap-4">
            <input
              ...
              className="bg-primary px-6 py-4 text-md border-2 w-[250px] md:w-[700px] lg:w-[350px] border-gray-100 focus:outline-none focus:border-2 focus:border-gray-300 flex-1 rounded-lg"
              placeholder="Add comment.."
            />
            <button
              className="text-md text-white bg-cyan-500 px-4 py-2 rounded-xl hover:bg-cyan-600 duration-300"
              onClick={addComment}
            >
